...
def get_player_move(towers):
    ...
    while True:  # Keeps asking the player until they enter a valid move.
        ...
        # Use more descriptive varible names:
        ...
        if towers[to_tower][-1] < towers[from_tower][-1]:
...
def display_towers(towers):
    ...
    # Display the towers label A, B, and C:
